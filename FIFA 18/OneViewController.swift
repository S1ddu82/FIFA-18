...
class OneViewController: UIViewController,UIPickerViewDelegate,UIPickerViewDataSource,UIToolbarDelegate {
...
Delegate.Team = TeamName.text
Delegate.Team1 = TeamName.text
